...
$sql2 = "SELECT * FROM Cad_Children WHERE Batizado = '$data' order by Nome ASC LIMIT $limit OFFSET $offset";
...
<div class="tabela">
        ...
        $data = $_POST['data'] ?? '';
        ?>
        <form action="listapdf.php?Batizado=<?php echo $data; ?>" method="POST">
            <label for="">Pesquise pela data do batizado, depois clique no botão Gerar Lista de Presença.</label><br>
            <button type="submit">Gerar Lista de Presença</button>
        </form>
        <br>